 ...
 *
 * Dev chrome (tier pill, debug toggle, instrument rails) lives in `$rig/…` — ReTreever owns it, synced here by syncRetreeved.sh — and renders only in `vite dev`, never a build.
 *
